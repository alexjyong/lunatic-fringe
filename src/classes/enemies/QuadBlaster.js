...
export class QuadBlaster extends KillableAiGameObject {
    ...
    constructor(xLocation, yLocation, velocityX, velocityY, playerShip) {
        ...
        super(xLocation, yLocation, Layer.QUAD_BLASTER, 40, 50, 0, MediaManager.Sprites.QuadBlaster, velocityX, velocityY, 16, 8, playerShip, 60, 160, GameConfig.QUADBLASTER_POINT_VALUE);
